...
export function Player(): JSX.Element {
	const {
		...
		useCurrentPodcast: [currentPodcast],
		handleNext,
		handlePrev,
	} = usePlayer();
	...
	return (
		...
		>
			{currentPodcast && (
				...
				>
					<source type="audio/mpeg" src={currentPodcast.episodeUrl} />
				</audio>
			)}
			...
			<section className=" flex max-md:flex-col max-md:items-stretch max-md:gap-0">
				<div className="flex flex-col items-stretch h-full ">
					<img
						...
						// srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/b120fec8-1a93-4f04-9bca-0b64c0273991?apiKey=70259793749c4d08babc2ab577934360&"
						className="aspect-square object-cover object-center min-w-[110px] overflow-hidden shrink-0 max-md:mt-5"
						alt=""
					/>
					{/* <img src={currentPodcast?.image} alt={currentPodcast?.title} /> */}
				</div>
				...
				<div className="flex flex-col items-stretch w-[9%] ml-5 max-md:w-full">
					<div className="flex gap-3 my-auto max-md:mt-12 items-center">
